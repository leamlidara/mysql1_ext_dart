...
class BufferedSocket {
  ...
  void _writeBuffer() {
    ...
    final bytesWritten = _writingBuffer!.writeToSocket(_socket, _writeOffset, _writeLength - _writeOffset);
  ...
  void _readBuffer() {
    final bytesRead = _readingBuffer!.readFromSocket(_socket, _readingBuffer!.length - _readOffset);
